      ...
      <nav className={useClasses.nav}>
        ...
        <div className={useClasses.container}>
          ...
          <div className={useClasses.desktopButtonGroup}>
            <button className={useClasses.desktopSignUpButton}>Sign Up</button>
            <button className={useClasses.desktopSignInButton}>Sign In</button>
          </div>

          {/* Burger Icon */}
          <div onClick={handleMenu} className={useClasses.desktopToggleMenu}>
            <svg
        ...
        {/* Mobile */}
        <div className={`${open ? "block" : "hidden"} sm:hidden mt-4 mx-auto`}>
